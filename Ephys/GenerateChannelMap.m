...
data = readstruct('Y:\Joaquin\Chronics\cSC2\Matt Arena\Matt Dorsal - Day 2\Matt Dorsal - Day 2 - Ephys\Trial 1 - MAdD2 - cSC2 2024-08-13_13-51-43 - Copy\Record Node 101\settings.xml');
...
save(['Y:\Joaquin\Chronics\cSC2\Channel Maps\Final\' char("Dorsal_SC_cSC2") 'ChanMap.mat'],'chanMap','xcoords','ycoords','chanMap0ind','connected','kcoords','name')
